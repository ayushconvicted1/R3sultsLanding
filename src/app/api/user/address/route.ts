...
/**
 * PATCH /api/user/address – Proxy to external PATCH /api/user/address.
 * Body: address, city, state, country, pincode (per API_USAGE.csv).
 */
export async function PATCH(request: NextRequest) {
  ...
  const keys = ["address", "city", "state", "country", "pincode"] as const;
