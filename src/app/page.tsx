    ...
    <div className="w-full">
      ...
      <section className="instagram-reels-section py-14 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="reels-carousel-wrapper mt-10">
            <div className="reels-carousel-left">
              {[
                ...
                return (
                  <div
                    key={`left-${idx}`}
                    className="relative flex-none w-[220px] sm:w-[260px] md:w-[280px] aspect-[9/16] rounded-2xl overflow-hidden shadow-xl group bg-black"
                  >
                    {isInstagram ? (
                      <iframe
                        src={embedUrl}
