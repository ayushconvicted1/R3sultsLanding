    ...
    <div className="w-full">
      ...
      {/* <section className="instagram-reels-section py-14 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-nowrap overflow-x-auto pb-8 gap-4 sm:gap-6 snap-x no-scrollbar">
            {homeData.instagramReels.reels.map((reel, idx) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="relative flex-none w-[220px] sm:w-[260px] md:w-[280px] aspect-[9/16] rounded-2xl overflow-hidden shadow-xl group snap-center bg-black"
              >
                <video
                  src={reel.videoPath}
